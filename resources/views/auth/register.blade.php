                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" onsubmit="return checkTerms()"}>
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="">
                                <input placeholder="name@example.com" id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group">
                            <label placeholder="Confirm your password" for="password-confirm" class="col-md-4 control-label">Confirm Password</label>
                        ...
                        <div>
                            ...
                            <input class="custom-control-input" type="checkbox"  name="terms" id="terms" {{ old('remember') ? 'checked' : '' }} checked><span class="custom-control-indicator"></span><span class="custom-control-description">I have read and agree to the </span>
                        </label><a class="navi-link" href="/terms"> terms and conditions</a> of the use of this service.
                        </div>
