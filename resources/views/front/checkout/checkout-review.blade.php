...
<div class="row">
            ...
            @foreach($cartItems as $cartItem)
              <tr>
                <td>
                  ...
                  <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="/storage/products/{{$cartItem->options->img}}" height="100px" width="150px" /></a>
                    <div class="product-info">
                      <h4 class="product-title"><a href="shop-single.html">Ksh{{$cartItem->price}}</a></h4><span><em>Size:</em> -</span><span><em>Color:</em> Turquoise</span>
                    </div>
                  </div>
                </td>
    ...
    <div class="row padding-top-1x mt-3">
        ...
        <ul class="list-unstyled">
            ...
            <li><span class="text-muted">Client:</span>Username</li>
            @else
            <li><span class="text-muted">Client:</span>{{Auth::user()->name}}</li>
            @endif

            <li><span class="text-muted">Address:</span>User's address, City, Country</li>

            <li><span class="text-muted">Phone:</span>+2547XXXXXXXX</li>
    ...
    <aside class="sidebar">
        ...
        <table class="table">
            ...
            <td class="text-lg text-medium">Ksh. {{Cart::total()}}</td>
