...
<div class="row">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="email" id="checkout-email" required="">
        </div>
        </div>
        <div class="col-sm-6">
        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" id="checkout-company" required="">
        </div>
        </div>
        <div class="col-sm-6">
        <div class="form-group">
    ...
    <aside class="sidebar">
        ...
        <table class="table">
            ...
            <tr>
            <td>Shipping:</td>
            <td class="text-medium">KShs. {{Cart::subtotal() * 1.13 }}</td>
            </tr>
            <tr>
            <td>Estimated tax:</td>
