 ...
 <div class="row">
  ...
  <div class="col-xl-9 col-lg-8">
    ...
    <div class="checkout-steps">
        ...
        <a class="active" href=""><!--span class="angle"></span-->1. Shipping</a>
    </div>
...
=======
            <input class="form-control" type="text" id="checkout-date" required="" name="deliveryDate"  placeholder="yr/m/dd">
>>>>>>> 07575e8f36c8c71cc2f55165352c1248ae6d4754
        </div>
        </div>
        <div class="col-sm-9">
        <div class="form-group">
