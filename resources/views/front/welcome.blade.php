      ...
      <section class="container padding-top-1x">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 ">
            <div class="card categories  mb-30" style="background-image:url({{ 'uploads/'.$category->image }}); background-blend-mode: multiply; background-color:#444; background-size:cover; background-position:center;"><a class="card-img-tiles"  href="/shop-grid">
                <div class="inner">
                </div></a>
              <div class="card-block text-center " style=" border-radius:3px; background-blend-mode: multiply;">
                ...
                <p class="text-muted" style="">{{ $category->description }}</p>
                <a class="btn btn-primary " style=""  href="/shop/{{ $category->id }}/category">{{ $category->title }}</a>
              </div>
            </div>
          </div>
          @endforeach
