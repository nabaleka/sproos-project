            ...
            <div class="container padding-top-3x">
              <div class="row align-items-center">
                <div class="col-lg-5 offset-lg-1 col-md-6 padding-bottom-2x text-md-left text-center">
                  ...
                  </div><a class="btn btn-primary scale-up delay-1" href="/shop-grid">View Offers</a>
                </div>
        ...
        <!-- Loop through -->
          <div class="grid-item">
            <div class="product-card">
              <div class="product-badge text-danger"></div><a class="product-thumb" href="/shop-single/{{$product->id}}"><img href="/shop-single/{{$product->id}}" src= {{Storage::url('products/'.$product->image)}} height="100px" width="150px" /></a>
