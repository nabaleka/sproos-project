...
<div class="cart"><a href="/cart"></a><i class="icon-bag"></i><span class="count">{{Cart::count()}}</span><span class="subtotal">{{Cart::subtotal()}}</span>
    ...
    <div class="dropdown-product-item"><span class="dropdown-product-remove"><a href="{{'/delete_cart'}}/<?php echo $cartItem->rowId?>"><i class="icon-cross"></i></span></a><a class="dropdown-product-thumb" href=""><img src="{{asset('uploads/'.$cartItem->options->img) }}" height="100px" width="150px" />
                </a></a>
