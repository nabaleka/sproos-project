...
<input type="hidden" name="business" value="humluchetu@gmail.com">
...
<input type="hidden" name="shipping_{{$count}}" value="Session::get('shipping_method')}}">

<input type="hidden" name="tax_{{$count}}" value="0.12">

<!-- after payment -->
 <input type="hidden" name="return" id="return" value="http://127.0.0.1:8000/checkout-review" />
<!-- Cancel payment -->
  <input type="hidden" name="cancel_return" id="cancel_return" value="http://127.0.0.1:8000/checkout-payment" />
  <br>
@endforeach
