...
<div class="row">
    ...
    <div class="table-responsive">
        ...
        <tbody>
            ...
            <td class="align-middle">Ksh. 22.50</td>
            ...
            <td class="align-middle">Ksh. 0.00</td>
            <td class="align-middle">
                <label class="custom-control custom-radio">
            ...
            <tr>
            <td class="align-middle"><span class="text-medium">Pick Up at Known Landmarks</span><br><span class="text-muted text-sm">All Addresses(default zone), United States & Canada</span></td>
            <td class="align-middle">&mdash;</td>
            <td class="align-middle">Ksh. 9.99</td>
            <td class="align-middle">
                <label class="custom-control custom-radio">
                <input class="custom-control-input" type="radio" name="shipping-method"><span class="custom-control-indicator"></span>
                </label>
